document.addEventListener('DOMContentLoaded', () => {
    ...
    let currentInterval = null; // Keep track of the current interval
    let isPlaying;
    // Initialize a variable to keep track of whether the song is "loved"
    let isLoved = false;

    const images = [ 'img3.jpg','img4.jpg', 'img5.jpg', 'img3.jpg', 'img4.jpg','img5.jpg', 'img3.jpg', 'img6.jpg'];

    const songs = [
        {
            audio: 'y2mate.com - Vybz Kartel  The Comet Official Music Video.mp3', 
            start: 83, 
            duration: 30, 
            quote: "In the chaos of life, we blaze like comets—unpredictable, unstoppable."
        },
        {
            audio: "y2mate.com - Alkaline  Fleek Official Music Video.mp3", 
            start: 21, 
            duration: 21, 
            quote: "Style is more than what you wear, it’s the energy you carry."
        },
        {
            audio: "y2mate.com - Jahmiel  U Me Luv Lyrics.mp3", 
            start: 27, 
            duration: 16, 
            quote: "True love isn’t just said, it’s felt deeply, unconditionally"
        },
        {
            audio: "y2mate.com - Charly Black  Youre Perfect Official Video.mp3", 
            start: 7, 
            duration: 10, 
            quote: "In a world of imperfection, you’re my perfect balance."
        },
        {
        ...
        },
        {
            ...
            start: 54, 
            duration: 23, 
            quote: "Youth is not just a phase, but a state of mind—forever alive in the spirit"
        },
        {
            audio: "y2mate.com - Charly Black  Youre Perfect Official Video.mp3", 
            start: 45, 
            duration: 20, 
            quote: "Perfection isn't flawless; it's loving someone just as they are."
        }
    ...
    supriseBtn.addEventListener('click', () => {alternateIntroAndContent(true); slidePlayList(false); slidePlayList(false)});
    ...
    function displayPlayers() {
        songs.forEach((song, index) => {
           ...
           createItems(content, song, index);
    ...
    function createItems(parent,song, index) {
        ...
        loveBtn.addEventListener('click', () => {
            ...
            if (index === 3 || index === 7){
                ...
                window.open('https://www.youtube.com/@infectedDoctorB', '_blank');
            }
    ...
    function playsong(audioSrc, startTime, duration, timeBar, playBtn,lyricsDiv, quote) {
        ...
        const allTimeBars = document.querySelectorAll('.time-bar');
        allTimeBars.forEach(bar => {
            bar.style.width = '0%';
        });
        ...
        if (currentsong && !currentsong.paused) {
            ...
            lyricsDiv.innerHTML = '';
            isPlaying = false;
            clearInterval(currentInterval); // Clear the interval when paused
        } else {
            ...
            currentsong.currentTime = startTime;
            currentsong.play();
            lyricsDiv.innerHTML = `<h2 class="quote-text">${quote}</h2> <p class="quote-author">Corazon Jojo</p>`;
            ...
            currentInterval = setInterval(() => {
                ...
                if (elapsedTime >= duration) {
                    ...
                    clearInterval(currentInterval);  // Stop updating the time bar
                    lyricsDiv.innerHTML = '';
                    slidePlayList(true);
                }
